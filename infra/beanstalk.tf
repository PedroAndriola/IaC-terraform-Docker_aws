...
resource "aws_elastic_beanstalk_environment" "ambiente_beanstalk" {
  name                = var.ambiente_beanstalk
  application         = aws_elastic_beanstalk_application.aplicacao_beanstalk 
